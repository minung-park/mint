...
def generate_data(utterances, word_vectors, dialogue_ontology, target_slot):
    ...
    for slot_idx, slot in enumerate(list_of_slots):
        ...
        #print "pos " + slot + " : " + str(len(positive_examples[slot]))
        #print "neg " + slot + " : " + str(len(negative_examples[slot]))
    ...
    def __init__(self, config_filepath):
        ...
        for slot in dialogue_ontology:
            ...
            if slot == "request":
                ...
                slot_vectors = numpy.zeros((len(dialogue_ontology[slot])+1, 300), dtype="float32") # int32 +1 for None
                value_vectors = numpy.zeros((len(dialogue_ontology[slot])+1, 300), dtype="float32") # int32
...
def main():
    ...
    try: 
        switch = sys.argv[1]
        if switch == "train": #train
            do_training = True
        elif switch == "woz": #test
            do_woz = True
    except:
