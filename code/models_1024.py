...
def define_CNN_model(utterance_representations_full, longest_utterance_length, num_filters=1024, vector_dimension=1024):
    """
...
def model_definition(vector_dimension, label_count, slot_vectors, value_vectors, longest_utterance_length, use_delex_features=False, use_softmax=True, value_specific_decoder=False, learn_belief_state_update=True):
    """
    ...
    utterance_representations_full = tf.placeholder(tf.float32, [None, vector_dimension])
...
#    utterance_representations_delex = tf.placeholder(tf.float32, [None, label_size, 40, vector_dimension])
    ...
    h_utterance_representation = utterance_representations_full #define_CNN_model(utterance_representations_full, longest_utterance_length, num_filters, vector_dimension)
    ...
    if value_specific_decoder and False:
        ...
        h_utterance_representation_for_full_softmax = utterance_representations_full #define_CNN_model(utterance_representations_full, num_filters, vector_dimension, longest_utterance_length)
